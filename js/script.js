...
function mushrooms() {
    var mushroom = 0;
    var addMushroom = document.getElementById("toping1");
...
function sausages() {
    var sausage = 0;
    var addsausage = document.getElementById("toping1");
...
function onions() {
    var onion = 0;
    var addonions = document.getElementById("toping1");
    if (addMushroom.checked === true) {
        onion = 130;
    }
...
function tikkaSaucee() {
    var tikkaSauce = 0;
    var addtikkaSauce = document.getElementById("toping1");
...
function mozarellaCheese() {
    var cheese = 0;
    var addmozarellaCheese = document.getElementById("toping1");
...
$(document).ready(function () {
    $("#delivery").submit(function () {
        ...
        alert("Hello " + name + ". Your order has been successfuly received and will be delivered to " +  location + " within one hour.The delivery will cost ksh 180/= Thank you for chosing YummyPizza !");
        // $(this).get(0).reset();
        //  event.preventDefault();
    });
